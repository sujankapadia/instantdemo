...
Source files: `/Users/skapadia/dev/personal/instantdemo/PIPELINE.md`, `/Users/skapadia/dev/personal/instantdemo/CLAUDE.md`, `/Users/skapadia/dev/personal/instantdemo/active-sessions-script.json`
...
Source file: `/Users/skapadia/dev/personal/instantdemo/run_demo.py`
...
Copy `/Users/skapadia/dev/personal/instantdemo/active-sessions-script.json` to `templates/example-script.json`. No changes.
...
- Update `/Users/skapadia/dev/personal/instantdemo/CLAUDE.md` — note the project is now packaged as a Claude Code skill, add installation instructions
- Update `/Users/skapadia/dev/personal/instantdemo/README.md` — add skill installation section
