...
- **Spike report**: `/Users/skapadia/dev/personal/instantdemo-sdk-spike/REPORT.md`
- **Spike code (use as `query()` template)**: `/Users/skapadia/dev/personal/instantdemo-sdk-spike/spike.py`
