...
(GL1/GL2 share one test — the canned harness asserts in-loop validation; EL3 is covered by the existing M5b suite (test_scoped_replan) remaining green plus the live rehearsal smoke. EL4 reuses the EL harness with a fake dispatcher injected; EL1/EL2 run with dispatcher=None as before.)
